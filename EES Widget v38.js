...
const mainColor= "#000000"; // black // dark colors work best
const headerColor= "#76CEB5"; // seafoam blue // controls the bottom headers
const descColor= "76CEB5"; // seafoam blue // controls metrics descriptors
