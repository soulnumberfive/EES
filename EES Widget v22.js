...
console.log(`Latest TBK tour dates: ${datesString}`);

// Check if the dates string matches the expected tour dates
const expectedDates = "Jun 15";

if (datesString !== "Jun 25, Jun 27, Jun 28, Jun 30, Jul 1, Jul 4, Jul 6, Jul 7, Jul 8, Jul 10, Aug 14, Aug 24, Aug 25, Aug 26, Aug 27, Sep 16, Nov 18") {
  let notification = new Notification();
