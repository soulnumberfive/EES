...
// Set widget colors
const row1Color= "#B8860B"; // dark goldenrod // controls header color
const row2Color= "#EDEEE9"; // creamy white // controls data color
const eesColor = "#B8860B"; // dark goldenrod // controls EES crown color
...
console.log(`Latest EES release (${formattedDate}): ${artist} - ${releaseTitle}`);
...
// Access timeDiff outside of the function
