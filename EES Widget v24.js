...
const imageUrl = "https://i.ibb.co/qYwB3d5/IMG-9821.png"; // replace this with the URL of your image
...
updateTitle.textColor = new Color("#000000")
  if (lastUpdate) {
    ...
    updateText.textColor = new Color("#fffde4");
...
ototoyTitle.textColor = new Color("#000000")
const ototoyText3 = ototoyStack.addText(`${secondRelease}`);
ototoyText3.font = Font.boldSystemFont(22);
ototoyText3.textColor = new Color("#fffde4");
  if (firstRelease != "What Goes Around (Comes Around)") {
    let notification = new Notification();
...
checkText.textColor = Color.black();
...
if (datesString !== "Wed, Jun 28, Fri, Jun 30, Sat, Jul 1, Tue, Jul 4, Thu, Jul 6, Fri, Jul 7, Sat, Jul 8, Mon, Jul 10, Mon, Aug 14, Thu, Aug 24, Fri, Aug 25, Sat, Aug 26, Sun, Aug 27, Sat, Sep 16, Sat, Nov 18, ") {
  let notification = new Notification();
